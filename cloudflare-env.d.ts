/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: fc08d9cb4e65825cb08ebb023076cc96)
// Runtime types generated with workerd@1.20260409.1 2026-04-10 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* personal-dev-cloudflare-next-starter */;
	}
}
